...
blocks:
  ...
  - { id: b2, type: diapason, min: 10, exercise: notas-6a-cuerda, tool: "/escalas?root=E&type=chromatic" }
  - { id: b3, type: oido, min: 7, exercise: metronomo-2y4, tool: "/metronomo?bpm=60&sub=1" }
  - { id: b4, type: aplicacion, min: 10, exercise: blues-f-pentatonica, song: blues-en-fa }
...
- Cuerpo MDX: breve (el player ya renderiza los bloques). Explica el *porqué*
