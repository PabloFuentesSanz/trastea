  ...
  return (
    <main className="dark flex-1 bg-background text-foreground">
      <div className="mx-auto w-full max-w-2xl px-4 py-8">
        <h1 className="text-4xl">Afinador</h1>
        <p className="text-muted-foreground mt-1">
          Toca una cuerda al aire y te dice cuánto le falta, en cents. Nueve afinaciones,
          y cada cuerda suena para afinar de oído si prefieres.
        </p>
        ...
        <section aria-label="Cómo afinar bien" className="mt-10">
          ...
          <ul className="text-muted-foreground mt-3 space-y-2 text-sm">
            <li>
              ...
              Si te pasas, afloja por debajo y vuelve a subir: la cuerda se asienta
              tirando, y si llegas aflojando se desafina sola en dos minutos.
            </li>
            <li>
              <strong className="text-foreground">
            ...
            <li>
              ...
              de ellas suavemente hacia arriba y vuelve a afinar, tres o cuatro veces,
              hasta que deje de bajar.
            </li>
          </ul>
        </section>
      </div>
